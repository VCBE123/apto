...
class TrainMNIST(Trainable):
	def _setup(self, config):
		...
		self.train_loader = torch.utils.data.DataLoader(datasets.MNIST("/home/wen/Desktop/apto/data/", train=True,
														...
														**kwargs)
		self.test_loader = torch.utils.data.DataLoader(datasets.MNIST("/home/wen/Desktop/apto/data/", train=False,
...
if __name__ == '__main__':
	...
	tune.run(TrainMNIST, scheduler=sched,
			 **{"stop": {"mean_accuracy": 0.95, "training_iteration": 1 if args.smoke_test else 50, },
				"resources_per_trial": {"cpu": 3, "gpu": int(not args.no_cuda)},
				"num_samples": 1 if args.smoke_test else 20,
				"checkpoint_at_end": True,
				"config": {"args": args, "lr": tune.uniform(0.001, 0.1), "momentum": tune.uniform(0.1, 0.9), }},reuse_actors=False)
